    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="<?php echo e(url ('/')); ?>" class="btn btn-purple"><i class="fa fa-chevron-left"></i> Kembali </a>
        </div>
        <div class="box-body">
         <form action="<?php echo e(empty($result) ? url('kelas/add') : url("kelas/$result->id_kelas/edit")); ?>" class="form-horizontal" method="POST">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_kelas" class="form-control" placeholder="Masukan Nama Kelas" value="<?php echo e(@$result->nama_kelas); ?>" />
            </div>
          </div>
