    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="<?php echo e(url ('siswa')); ?>" class="btn btn-purple"><i class="fa fa-chevron-left"></i> Kembali </a>
        </div>
        <div class="box-body">
         <form action="<?php echo e(empty($result) ? url('siswa/add') : url("siswa/$result->nis/edit")); ?>" class="form-horizontal" method="POST" enctype=”multipart/form-data” >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="no_telp" class="form-control" placeholder="Masukan No Telp" value="<?php echo e(@$result->no_telp); ?>"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="id_kelas" class="form-control">
                <?php foreach(\App\Kelas::all() as $kelas): ?>
